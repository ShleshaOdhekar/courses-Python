...
mainFrame = Frame(app, height=3700)
...
def cal_score():
    ...
    mainFrame = Frame(root1, height=2400)
    canvas = Canvas(mainFrame)
    scrollbar = Scrollbar(mainFrame,
                          orient='vertical',
                          command=canvas.yview
    ...
    root1.title("PYTHON QUIZ")
    question_answer = [
        {
            'question': '1.What is used to define a block of code (body of loop, function etc.) in Python?',
            'answer': ['Curly braces', 'Parethesis', 'Indentation', 'Quotation']
        },

        {
            'question': '2.What is used to take input from the user in Python?',
            'answer': ['cin()', 'scanf()', 'input()', '<>']
        },

        {
            'question': '3.The statement using and operator results true if __',
            'answer': ['Both operands are true', 'Both operands are false', 'Either of the operand is true',
                       'first operand is true']
        },

        {
            'question': '4.Which of the following statement is correct?',
            'answer': ['List is mutable & Tuple is immutable', 'List is immutable & Tuple is mutable',
                       'Both are Mutable',
                       'Both are Immutable']
        },
        {
            'question': '5.Which keyword is used to define methods in Python?',
            'answer': ['function', 'def', 'method', 'all of these']
        }
    ]


    f0 = Frame(scrollable_frame, width=800, height=40)
    Label(f0, text="ASSIGNMENT RESULTS", font="lucida 23 bold", height=0, fg="white", bg="black").pack(anchor="center",side="top",padx=580)
    f0.pack(side="top")

    Label(scrollable_frame, text="Thank you for answering the questions. " + str(score) + " of " + str(len(question_answer)) + " questions answered right", font="Verdana 15 bold", relief='solid', bg='green',fg='white').pack(anchor="center",pady=25, ipadx=10)
    ...
    l121 = Label(scrollable_frame, text="c)"+" "+question_answer[0]['answer'][2], fg="green",font="lucida 12 normal")
    l121.pack(anchor='w')
    ...
    l401 = Label(scrollable_frame, text="a)"+" "+question_answer[3]['answer'][0],fg="green",font="lucida 12 normal")
    l401.pack(anchor='w')

    l411 = Label(scrollable_frame, text="b)"+" "+question_answer[3]['answer'][1],font="lucida 12 normal")
    l411.pack(anchor='w')

    l421 = Label(scrollable_frame, text="c)"+" "+question_answer[3]['answer'][2],font="lucida 12 normal")
    l421.pack(anchor='w')
    ...
    l511 = Label(scrollable_frame, text="b)"+" "+question_answer[4]['answer'][1],fg="green",font="lucida 12 normal")
    l511.pack(anchor='w')
...
def pquiz():
    ...
    f0 = Frame(scrollable_frame, width=800, height=40)
    Label(f0, text="PYTHON ASSIGNMENT", font="lucida 23 bold", height=0, fg="white", bg="black").pack(anchor="center",
                                                                                                      side="top",
                                                                                                      padx=580)
    ...
    Button(scrollable_frame, fg="white", padx=120, pady=5, bg='black', textvariable=button_label, command=close).pack(anchor="nw")
...
submit = Button(scrollable_frame, text="Go for Quiz", fg="white", bg='Maroon',command=pquiz)
