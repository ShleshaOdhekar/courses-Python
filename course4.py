...
#code
photo1 = PhotoImage(file = r"coatopic.png")
...
photo = PhotoImage(file = r"coalec.png") 
...
coa1= PhotoImage(file=r'coa1.png')

label2= Label(tab1, font=("Times", 20),text="Coa Tutorial: This reference will take you through simple and practical approaches of computer architecture and organization.")
label2.pack(pady=20, padx=20,fill='x')
lb2= Label(tab1, image=coa1)
lb2.pack(pady=20,padx=20, fill='x')
title2= Label(tab2, text="Week 2", font=("Times", 20), fg="#349310", bg="#F4F4A3")
title2.pack(pady=30, fill='x')
coa2= PhotoImage(file=r'coa2.png')
label3= Label(tab2, image=coa2)
...
coa3= PhotoImage(file=r'coa3.png')
label4=Label(tab3, image=coa3)
...
coa4= PhotoImage(file=r'coa4.png')

label5=Label(tab4, image=coa4)
...
def cal_score():
    ...
    root1.title("COA QUIZ")
    question_answer = [
        {
            'question': '1.Assembly language programs are written using?',
            'answer': ['Mnemonics', 'ASCII code', 'HEX code', 'Binary format']
        },

        {
            'question': '2.The last statement of the source program should be _______',
            'answer': ['Return', 'End', 'Stop', 'None of the above']
        },

        {
            'question': '3.A machine language instruction format consists of',
            'answer': ['Operation field', 'Operand field', 'Operation code field & operand field', 'None of the above']
        },

        {
            'question': '4.The instructions like MOV or ADD are called as ______',
            'answer': ['OP code', 'Commands', 'Operators', 'None of the above']

        },
        {
            'question': '5.Which of the following is not an arithmetic instruction??',
            'answer': ['INC(increament)', 'DEC(decreament)', 'CMP(compare)', 'ROL(rotate left)']
        }
    ...
    l321 = Label(scrollable_frame, text="c)" + " " + question_answer[2]['answer'][2], fg="green",
                 font="lucida 12 normal")
    l321.pack(anchor='w')
    ...
    l401 = Label(scrollable_frame, text="a)" + " " + question_answer[3]['answer'][0], fg="green",
                 font="lucida 12 normal")
    l401.pack(anchor='w')
    ...
    l531 = Label(scrollable_frame, text="d)" + " " + question_answer[4]['answer'][3], fg="green",
                 font="lucida 12 normal")
    l531.pack(anchor='w')
...
def coaquiz():
    ...
    f0 = Frame(scrollable_frame, width=800, height=40)
    Label(f0, text="COA ASSIGNMENT", font="lucida 23 bold", height=0, fg="white", bg="black").pack(anchor="center",
                                                                                                   side="top", padx=580)
    f0.pack(side='top')
...
submit = Button(scrollable_frame, text="Go for Quiz", fg="white", bg='Maroon',command=coaquiz)
