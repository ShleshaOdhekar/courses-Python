...
class LoginWindow:
    ...
    def add_frame(self):
        ...
        self.img = PhotoImage(file='newwww.png')
        ...
        self.emlabel = Label(self.frame, text="Enter VesID")
        ...
        self.button = Button(self.frame, text="Login", font='Courier 15 bold', bg='#b02a30', fg='white',
                             command=self.login)
